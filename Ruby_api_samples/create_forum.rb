...
#Need to specify the category_id in the url 
#eg:
#site = RestClient::Resource.new("http://domain.freshdesk.com/categories/3/forums.json","sample@freshdesk.com","test")

site = RestClient::Resource.new("http://domain.freshdesk.com/categories/[category_id]/forums.json","sample@freshdesk.com","test")
