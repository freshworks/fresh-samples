...
class Program
{
    static void Main()
    {
        string json = "{ \"forum\": { \"description\": \"Ticket related functions\", \"forum_category_id\":1, \"forum_type\":2, \"forum_visibility\":1, \"name\":\"Ticket Operations\" }}";
        HttpWebRequest request = (HttpWebRequest)WebRequest.Create("http://domain.freshdesk.com/discussions/forums.json"); 
