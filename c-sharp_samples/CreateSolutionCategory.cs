...
class Program
{
    static void Main()
    {
        string json = "{ \"solution_category\": { \"name\":\"API\", \"description\":\"API related documents\" }}";
        HttpWebRequest request = (HttpWebRequest)WebRequest.Create("http://domain.freshdesk.com/solution/categories.json"); 
