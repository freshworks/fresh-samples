...
class Program
{
    static void Main()
    {
        string json = "{ \"customer\":{ \"name\":\"SuperNova\", \"domains\":\"supernova,nova\", \"description\":\"Spaceship Manufacturing Company\" }}";
        HttpWebRequest request = (HttpWebRequest)WebRequest.Create("http://domain.freshdesk.com/customers.json"); 
