...
Class Program
	Public Shared Sub Main()
		Dim json As String = "{""helpdesk_note"": {""body"":""This is a test of the note publisher"",""private"":""false""}}"
		Dim request As HttpWebRequest = DirectCast(WebRequest.Create("http://domain.freshdesk.com/helpdesk/tickets/35/conversations/note.json"), HttpWebRequest)
