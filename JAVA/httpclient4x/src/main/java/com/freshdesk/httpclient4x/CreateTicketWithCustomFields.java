...
public class CreateTicketWithCustomFields {
    public int createTicketWithCustomFields(String apiToken, String apiEndpoint) throws IOException, URISyntaxException {
        ...
        // Body:
        final String jsonBody = "{\"description\":\"Some details on the issue ...\",\"subject\":\"Support needed..\",\"email\":\"email@yourdomain.com\",\"priority\":1,\"status\":2, \"custom_fields\":{ \"department\": \"Finance\", \"category\": \"Questions\"}}";
