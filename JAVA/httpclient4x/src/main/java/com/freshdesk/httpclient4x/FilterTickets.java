...
public class FilterTickets {
    // filterQuery should be enclosed with a pair of double quotes
    // filterQuery = " \" priority:2 and (status:3 or status:2) \" "
    public int filterTickets(String apiToken, String apiEndpoint, String filterQuery) throws IOException, URISyntaxException {
